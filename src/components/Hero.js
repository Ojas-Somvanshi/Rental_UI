...
export default function Hero() {
  return (
    <section
      className="relative h-[70vh] sm:h-[75vh] lg:h-[80vh] flex items-center justify-center text-center text-white"
      style={{
        backgroundImage: "url('/hero-bg.jpg')",
        backgroundSize: "cover",
        backgroundPosition: "center",
    ...
    >
      ...
      <div className="relative z-10 px-4 max-w-5xl mx-auto">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight whitespace-normal md:whitespace-nowrap">
          Rent Bikes & Cars Anytime, Anywhere
        </h1>
        ...
        <button className="mt-6 bg-blue-600 px-5 py-2.5 sm:px-6 sm:py-3 rounded-lg text-base sm:text-lg hover:bg-blue-700 transition">
          Book Your Ride
        </button>
      </div>
    </section>
